...
<p>På position 0 finns följande värde: '
    <?= $mikael[0] ?>' och på position 4 finns värdet: '
    <?= $mikael[4] ?>'.
</p>

<p>Arrayen innehåller
    <?= $items ?> värden.
</p>

<p>På position 0 finns ett värde: '
    <?= $pos0HasValue ? "TRUE" : "FALSE" ?>' och på position 10 finns ett värde: '
    <?= $pos10HasValue ? "TRUE" : "FALSE" ?>'.
</p>
